...
class Model(models.Model):
    # NB: this should correspond to the actual folder name of the model inside csmtiser normalizer!
    name = models.CharField(max_length=10)
    to_dialect = models.ManyToManyField(Dialect, blank=True, verbose_name='Dialect')
    ...
    def retrain_model(self):
        if self.pk is not None and getattr(self, 'recordings_to_retrain').exists():
